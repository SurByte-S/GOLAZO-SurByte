...
export default function RankingPage({ user }: RankingPageProps) {
  ...
  return (
    <div className="space-y-8 pb-20">
      <header>
        <h1 className="text-4xl font-black text-zinc-900 tracking-tighter">Ranking & Puntos</h1>
        <p className="text-zinc-500 font-medium">Suma puntos jugando y canjealos por turnos gratis</p>
      </header>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* User Status */}
        <div className="lg:col-span-1 space-y-6">
          <Card className="bg-sky-600 border-none shadow-2xl rounded-3xl overflow-hidden text-white">
          ...
          <Card className="border-none shadow-sm rounded-3xl overflow-hidden bg-white">
            ...
            <CardContent className="space-y-4">
              <div className="p-4 bg-zinc-50 rounded-2xl border border-zinc-100 flex items-center justify-between opacity-50">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center shadow-sm">
                    <Trophy className="w-5 h-5 text-zinc-400" />
                  </div>
                  <div>
                    <p className="text-sm font-black text-zinc-900">Turno Gratis F5</p>
              ...
              <div className="p-4 bg-zinc-50 rounded-2xl border border-zinc-100 flex items-center justify-between opacity-50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-black text-zinc-900">Bebida Gratis</p>
                  ...
                  ranking.map((player, index) => (
                    <div 
                      ...
                      className={cn(
                        ...
                        player.id === user.id ? "bg-sky-50/50" : "hover:bg-zinc-50"
                      )}
                    >
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <p className="font-black text-zinc-900">
                              {player.name}
                              {player.id === user.id && <span className="ml-2 text-[10px] bg-sky-500 text-white px-2 py-0.5 rounded-full uppercase">Tú</span>}
                            </p>
                      ...
                      <div className="text-right">
                        <p className="text-2xl font-black text-zinc-900">{player.points}</p>
